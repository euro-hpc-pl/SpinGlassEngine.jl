...
cl_h = truncate_clustered_hamiltonian(cl_h, β, cs, results_folder, inst; tol=1e-6, iter=iter)
...
for tran ∈ all_lattice_transformations #[LatticeTransformation((1, 2, 3, 4), false), ]
    ...
    sol, s = low_energy_spectrum(ctr, search_params, merge_branches(ctr, :nofit, SingleLayerDroplets(eng, hamming_dist, :hamming)))
