...
function tensor_size(::Type{Site}, 
    network::AbstractGibbsNetwork{S, T}, 
    v::S
) where {S, T}
...
function tensor_size(::Type{Central{Vertical}},
    network::AbstractGibbsNetwork{S, T},
...
function tensor(::Type{Central{Horizontal}},
    network::AbstractGibbsNetwork{S, T},
...
function tensor_size(::Type{Central{Horizontal}},
    network::AbstractGibbsNetwork{S, T},
    w::Tuple{Int, Rational{Int}}
) where {S, T}
    i, r = w
...
function tensor(::Type{Central{Diagonal}},
    network::AbstractGibbsNetwork{S, T},
...
function tensor_size(::Type{Central{Diagonal}},
    network::AbstractGibbsNetwork{S, T},
    v::Tuple{Rational{Int}, Rational{Int}}
) where {S, T}
    r, s = v
...
function tensor_size(::Type{Reduced},
    network::PEPSNetwork{T},
    v::Tuple{Int, Int}
) where T <: Square
