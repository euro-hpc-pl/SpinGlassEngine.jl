...
function bench()
    ...
    open("/home/tsmierzchalski/tensor/chimera.csv", "w") do file
        ...
        for i ∈ 1:100
            if i < 10
                instance = "/home/tsmierzchalski/tensor/chimera2048_spinglass_power/00$(i).txt"

            elseif i ∈ 10:99
                instance = "/home/tsmierzchalski/tensor/chimera2048_spinglass_power/0$(i).txt"
            
            else 
                instance = "/home/tsmierzchalski/tensor/chimera2048_spinglass_power/$(i).txt"
            end
